...
<!--=====================
          Content
======================-->
<form id="frm" action="<%=request.getContextPath()%>/admin/category/delete/choicesub" method="get">
        ...
        <div class="box">
          <div class="row">
            <div class="grid_5 preffix_1">
              <h2>Root 카테고리 선택</h2>
              	삭제하고자하는 카테고리가 속하는 Root카테고리를 선택해주세요.<br><br>
            ...
            <div class="grid_5" id="conten">
              <h2>카테고리 삭제</h2>
              	Root카테고리 선택시 삭제가능한 카테고리의 리스트가 표시됩니다.<br>
            </div>
          </div>
        </div>
      </div>
