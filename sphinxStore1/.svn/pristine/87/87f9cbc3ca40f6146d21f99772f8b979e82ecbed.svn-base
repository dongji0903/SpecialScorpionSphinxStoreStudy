        ...
        <div class="banner">
          ...
          <div class="bann_capt ">
            <div class="maxheight">
              ...
              <div class="bann_title" style="font-size: 40px;">상품 등록</div>
              <a href="<%=request.getContextPath()%>/admin/product/add">바로가기</a>
            </div>
          </div>
        </div>
	   </div>
        ...
        <div class="banner">
          ...
          <div class="bann_capt  bn__1">
            <div class="maxheight">
              ...
              <div class="bann_title" style="font-size: 40px;">상품 수정</div>
              <a href="<%=request.getContextPath()%>/admin/product/edit/selectcategory">바로가기</a>
            </div>
          </div>
        </div>
		</div>
        ...
        <div class="banner ">
          ...
          <div class="bann_capt  bn__2">
            <div class="maxheight">
              ...
              <div class="bann_title" style="font-size: 40px;">뭐하딩</div>
              <a href="#">바로가기</a>
            </div>
          </div>
		  </div>
